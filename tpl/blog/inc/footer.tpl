...
<div class="footer-bar">
    <a class="icp" href="http://bcainfo.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank">
        京ICP备16059019号
    </a>
    <div>
        <a href="https://github.com/liuyongshuai" target="_blank">
    ...
    <div>
        <a href="https://weibo.com/liuyongshuai" target="_blank">
            <img src="{{ static_image "logo/weibo.png"}}" style="vertical-align: unset;width:16px;height:16px">
        </a>
    </div>
</div>
</body>
