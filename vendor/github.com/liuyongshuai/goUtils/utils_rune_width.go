// 源自：https://github.com/mattn/go-runewidth
//
...
func init() {
	...
	if env == "" {
		EastAsianWidth = IsEastAsianLocale()
	} else {
...
func IsEastAsianLocale() bool {
	...
	if max > 1 && (charset[0] != 'u' || strings.HasPrefix(locale, "ja") || strings.HasPrefix(locale, "ko") || strings.HasPrefix(locale, "zh")) {
		return true
	}
	return false
}
